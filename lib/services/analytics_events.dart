...
abstract class AbstractAnalyticsEvent {
  late final AnalyticsEvent value;
...
class SignupEvent extends AbstractAnalyticsEvent {
  SignupEvent() : super.withName(eventName: 'signup');
}
...
class TakePictureEvent extends AbstractAnalyticsEvent {
  TakePictureEvent._fromEvent( AnalyticsEvent event ) : super.withEvent( event: event );
